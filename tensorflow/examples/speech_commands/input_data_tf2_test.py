...
if __name__ == "__main__":
    ...
    print(type(train_fingerprints))
    print(train_fingerprints)

    # tf_train = tf.Tensor(train_fingerprints, shape=train_fingerprints.shape, dtype=tf.float32)
    tf_train = tf.constant(
        train_fingerprints.astype(np.float32),
        shape=train_fingerprints.shape,
        dtype=tf.float32,
    )
    print("---------- tf_train ---------")
    print(type(tf_train))
